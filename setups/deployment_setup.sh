...
sudo cp /vagrant/network_config/60-custom.yaml /etc/netplan/01-netcfg.yaml
...
cp /vagrant/kolla/globals.yml /home/vagrant/kolla
cp /vagrant/kolla/init-runonce /home/vagrant/kolla
